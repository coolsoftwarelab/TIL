...
#### 참조의 지역성 성질을 통해 캐쉬로 가져온 데이터에서 필요한 코드나 데이터를 읽을 확률이 높기 때문에 성능이 증가한다.

#### 메모리계층구조 (한 층의 메모리는 바로 아래층 메모리의 캐시 역할을 한다)

![](https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FbhESsH%2Fbtq66jM6yVJ%2FONQfq7soXSu5gUYUvNy2vk%2Fimg.png)
